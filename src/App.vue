...
const definitions = ref<{ [key: string]: string }>({})
const translations = ref<{ [key: string]: string }>({})
const transcriptions = ref<{ [key: string]: string }>({})
...
<template>
  <main>
    ...
    <footer><a href="https://github.com/ginpachi987/eseniya" target="_blank">v0.0.2</a></footer>
  </main>
